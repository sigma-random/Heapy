...
class HeapyGuiManager:
    ...
    def getChunkGuiSizeBySize(self,size):
    ...
    def build_heap_state(self):
        for chunk in self.current_state_obj: # now let's append all the block related to chunks
            if chunk.status == "allocated":
                ...
                block_layout = "width: 100%; height: " + str(self.getChunkGuiSizeBySize(int(chunk.full_chunk_size,10))) + "%; background-color: rgb(RXXX, GXXX, BXXX);;"
            ...
            if chunk.status == "free":
                ...
                block_tag = self.soup.new_tag("div")
                block_tag['class'] = "block normal"
                block_layout = "width: 100%; height: " + str(self.getChunkGuiSizeBySize(int(chunk.full_chunk_size,10))) + "%; background-color: rgb(255, 255, 255);;"
                block_tag['style'] = block_layout
                block_tag.string = "[FREE SPACE]"
